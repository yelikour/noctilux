...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "random_resized_crop",
            {"scale_min": 0.5, "scale_max": 0.8, "ratio_min": 0.75, "ratio_max": 1.25, "output_width": 32, "output_height": 32},
            {"RGB"},
        ),
        ("square_crop", {}, {"RGB"}),
        ("horizontal_flip", {}, {"RGB"}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("random_resized_crop", {"scale_min": 0.8, "scale_max": 0.5, "ratio_min": 0.75, "ratio_max": 1.25, "output_width": 32, "output_height": 32}),
